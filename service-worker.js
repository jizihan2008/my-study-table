...
const PRECACHE_URLS = [
  ...
  './js/core.js?v=20260826-r2',
  './js/sync-policy.js?v=20260825-r1',
  './js/sync.js?v=20260826-r12',
  './js/sync-logs.js?v=20260826-r5',
  './js/ai-utils.js?v=20260826-r2',
  './js/bg-media-idb.js?v=20260823-r1',
  './js/qq-chats.js?v=20260827-r1',
